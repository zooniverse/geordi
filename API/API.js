var API = require('fortune')
    , app = API({
        ...
        .resource('event', {
                      ...
                      subject_id: String, // the zooniverse ID of the subject for which the event occurred
                      user_id: String, // the zooniverse ID of the user performing the action
                      type: String, // one of: 'login','favourite','collect','share','meme','tweet','pin','classify','post','comment','idle','logout','talk','view'
